/*
  ...
  JS100 - JavaScript Basics > Objects > Cloning a Person
...
// Note that all 3 properties have the same value. However, what happens if we modify
// these values in one of the two objects and then inspect both objects?
...
/*
As you might expect, the values for the number and string keys changed in objCopy, 
but not in obj. However, when we mutated the value of objCopy.array, it also mutated 
that value of obj.array. That's because a shallow copy only copies pointers for nested 
objects; since arrays are objects, the shallow copy just copied the pointer to the 
original array to objCopy. If you're wondering why this happens, you might want to 
review Variables as Pointers section in the Introduction to JavaScript book
*/
